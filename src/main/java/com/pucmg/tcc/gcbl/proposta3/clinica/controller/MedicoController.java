...
public class MedicoController extends ModelController {
    ...
    public String tableEditGet(@RequestParam Map<String,String> allRequestParams, ModelMap model){
        System.out.println("teste");
        return null;
    }

    @RequestMapping(value={"/medicos"}, method = RequestMethod.POST)
    public String tableEditPost(@RequestParam Map<String,String> allRequestParams, ModelMap model){
        System.out.println("teste");
        return null;
    }
