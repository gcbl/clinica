                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <form:select path="paciente" id="paciente" style="width: 100%">
                              ...
                              <c:if test="${not empty solicitacao}">
                                  <form:option value="${solicitacao.paciente.id}" label="${solicitacao.paciente.nome}" />
                              </c:if>
                          </form:select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <form:select path="medicoSolicitante" id="medicoSolicitante" style="width: 100%">
                              <!-- No caso de estar editando -->
                              <c:if test="${not empty solicitacao}">
                                  <form:option value="${solicitacao.medicoSolicitante.id}" label="${solicitacao.medicoSolicitante.nome}" />
                              </c:if>
                          </form:select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4"> 
                          <form:select path="exames" multiple="true" style="width: 100%">
                              <!-- No caso de estar editando -->
                              <c:if test="${not empty solicitacao}">
                                  <form:options items="${solicitacao.exames}" itemValue="id" itemLabel="nome"/>
                              </c:if>
                          </form:select>
