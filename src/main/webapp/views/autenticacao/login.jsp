                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="account-wall">
                            ...
                            <form class="form-signin" action="/login" method="post">
                                ...
                                <input type="text"     class="form-control" name="username" value="1" placeholder="Email" required autofocus>
                                <input type="password" class="form-control" name="password" value="1" placeholder="Senha"     required>
